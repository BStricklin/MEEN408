// Author: Augustus Ellis, Blake Leiker, Anthony Hresko
#include "DCMOTOR.h"

DCMOTOR::DCMOTOR(int PWMChipNumberr, int PWMNumberr, int EQEPNumberr,
                 int GPIONumberHigh, int GPIONumberLow)
    : motorPWM(PWMChipNumberr, PWMNumberr, 1000000, 0),
